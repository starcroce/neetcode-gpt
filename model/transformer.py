...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.multi_heads = self.MultiHeadedSelfAttention(model_dim, num_heads)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.multi_heads(self.layer_norm1(embedded))
        embedded = embedded + self.mlp(self.layer_norm2(embedded))
